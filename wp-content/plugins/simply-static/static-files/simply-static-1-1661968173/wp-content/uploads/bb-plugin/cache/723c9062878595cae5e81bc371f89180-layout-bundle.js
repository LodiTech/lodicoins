...
$('.uabb-row-separator').parents('html').css('overflow-x','hidden');});var wpAjaxUrl='https://localhost/lodicoins/wp-admin/admin-ajax.php';var flBuilderUrl='https://localhost/lodicoins/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://localhost/lodicoins/wp-content/plugins/bb-plugin/',wpAjaxUrl:'https://localhost/lodicoins/wp-admin/admin-ajax.php'},breakpoints:{small:720,medium:1024},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
if('undefined'!==typeof wc_add_to_cart_params){wc_add_to_cart_params.wc_ajax_url+='&pp-advanced-menu-node='+this.settingsId+'&post-id='+this.postId;}},};})(jQuery);var pp_menu_tkcdl847j3pf;(function($){pp_menu_tkcdl847j3pf=new PPAdvancedMenu({id:'tkcdl847j3pf',type:'horizontal',mobile:'hamburger',menuPosition:'below',breakPoints:{medium:1024,small:720,custom:768},mobileBreakpoint:'mobile',mediaBreakpoint:'720',mobileMenuType:'off-canvas',offCanvasDirection:'right',fullScreenAnimation:'',postId:'19',isBuilderActive:false});})(jQuery);(function($){FLThemeBuilderHeaderLayout={win:null,body:null,header:null,overlay:false,hasAdminBar:false,stickyOn:'',breakpointWidth:0,init:function()
